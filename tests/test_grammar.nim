...
suite "RemotingMessage serialization and deserialization":
  ...
  test "method return with exception":
    ...
    let expected: seq[byte] = @[
      ...
      0x10, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
      0x06, 0x01, 0x00, 0x00, 0x00, 0x15, 0x44, 0x69, 0x76, 0x69, 0x64, 0x65, 0x42, 0x79, 0x5A, 0x65, 0x72, 0x6F, 0x45, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6F, 0x6E,
      0x0B
    ]
    check serialized == expected
    let deserialized = deserializeRemotingMessage(serialized)
  ...
  test "method call with method signature in array":
    ...
    let expected: seq[byte] = @[
      ...
      0x10, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
      0x06, 0x01, 0x00, 0x00, 0x00, 0x1B, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6D, 0x2E, 0x53, 0x74, 0x72, 0x69, 0x6E, 0x67, 0x2C, 0x20, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6D, 0x2E, 0x49, 0x6E, 0x74, 0x33, 0x32,
      0x0B
    ]
    check serialized == expected
    let deserialized = deserializeRemotingMessage(serialized)
  ...
  test "method call with generic method":
    ...
    let expected: seq[byte] = @[
      ...
      0x10, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
      0x06, 0x01, 0x00, 0x00, 0x00, 0x0C, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6D, 0x2E, 0x49, 0x6E, 0x74, 0x33, 0x32,
      0x0B
    ]
    check serialized == expected
    let deserialized = deserializeRemotingMessage(serialized)
